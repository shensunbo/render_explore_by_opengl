...
Description:
Automatically generate code and comments in English, regardless of the instruction language. This skill ensures all code, identifiers, and comments are written in English, even if user instructions are provided in Chinese or other languages.
